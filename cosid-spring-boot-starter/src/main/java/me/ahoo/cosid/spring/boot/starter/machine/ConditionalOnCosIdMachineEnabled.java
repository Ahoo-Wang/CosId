...
@ConditionalOnProperty(value = ConditionalOnCosIdMachineEnabled.ENABLED_KEY, matchIfMissing = false, havingValue = "true")
public @interface ConditionalOnCosIdMachineEnabled {
    String ENABLED_KEY = MachineProperties.PREFIX + EnabledSuffix.KEY;
}
