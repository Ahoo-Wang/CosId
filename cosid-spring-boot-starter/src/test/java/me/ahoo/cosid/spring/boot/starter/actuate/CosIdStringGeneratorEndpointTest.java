...
class CosIdStringGeneratorEndpointTest {
    ...
    private final CosIdStringGeneratorEndpoint cosIdGeneratorEndpoint = new CosIdStringGeneratorEndpoint(idGeneratorProvider);
    
    public CosIdStringGeneratorEndpointTest() {
