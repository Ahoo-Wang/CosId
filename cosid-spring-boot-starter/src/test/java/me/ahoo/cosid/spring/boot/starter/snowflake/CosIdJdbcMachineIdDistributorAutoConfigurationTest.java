...
class CosIdJdbcMachineIdDistributorAutoConfigurationTest {
    ...
    void contextLoads() {
        this.contextRunner
            ...
            .withPropertyValues(SnowflakeIdProperties.PREFIX + ".machine.distributor.type=jdbc")
            ...
            .withUserConfiguration(UtilAutoConfiguration.class, DataSourceAutoConfiguration.class, CosIdAutoConfiguration.class, CosIdSnowflakeAutoConfiguration.class)
