...
public class CosIdProperties {
    ...
    public static class Manual {
        public static final String ENABLED_KEY = CosId.COSID_PREFIX + "manual.enabled";
    ...
    public static class StatefulSet {
        public static final String ENABLED_KEY = CosId.COSID_PREFIX + "stateful-set.enabled";
        private boolean enabled;
    ...
    public static class Redis {
        public static final String ENABLED_KEY = CosId.COSID_PREFIX + "redis.enabled";
        private boolean enabled;
