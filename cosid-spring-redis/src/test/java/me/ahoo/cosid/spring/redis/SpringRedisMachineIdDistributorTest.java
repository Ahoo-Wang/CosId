...
class SpringRedisMachineIdDistributorTest {
    ...
    SpringRedisMachineIdDistributor redisMachineIdDistributor;
    ...
    private void initRedis() {
        ...
        redisMachineIdDistributor = new SpringRedisMachineIdDistributor(stringRedisTemplate, MachineStateStorage.LOCAL, ClockBackwardsSynchronizer.DEFAULT);
    }
