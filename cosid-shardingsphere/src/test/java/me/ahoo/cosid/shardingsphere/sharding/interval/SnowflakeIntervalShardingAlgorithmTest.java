...
class SnowflakeIntervalShardingAlgorithmTest extends AbstractIntervalShardingAlgorithmTest {
    ...
    public void doShardingPrecise() {
        ...
        PreciseShardingValue shardingValue = new PreciseShardingValue<>(LOGIC_NAME, COLUMN_NAME, DATA_NODE_INFO, id);
    ...
    public void doShardingRange() {
        ...
        RangeShardingValue shardingValue = new RangeShardingValue<>(LOGIC_NAME, COLUMN_NAME, DATA_NODE_INFO, Range.closed(lower, upper));
    ...
    public void doShardingPreciseRadix62IdConverter() {
        ...
        radix62ShardingAlgorithm.init(properties);
        ...
        PreciseShardingValue shardingValue = new PreciseShardingValue<>(LOGIC_NAME, COLUMN_NAME, DATA_NODE_INFO, idStr);
