...
class CosIdReactiveMongoSegmentAutoConfigurationTest {
    ...
    void contextLoads() {
        this.contextRunner
            ...
            .withUserConfiguration(MongoReactiveAutoConfiguration.class, CosIdMongoSegmentAutoConfiguration.class)
            .run(context -> {
