...
- `SegmentChainId`(**推荐**):`SegmentChainId` (*lock-free*) 是对 `SegmentId` 的增强。性能可达到近似 `AtomicLong` 的 *TPS 性能:12743W+/s* [JMH 基准测试](perf-test) 。
...
<p align="center" >
  <img src="../public/assets/design/RedisMachineIdDistributor.png" alt="RedisMachineIdDistributor"/>
</p>
